...
(function ($) {
    ...
    menuOverlay.on('click', function() {
        ...
        if (mobileMenuButton.hasClass('opened')) {
            mobileMenuButton.attr('aria-expanded', false).removeClass('opened');
            mobileContainer.find('.mobile-icon-menu').removeClass('hidden');
