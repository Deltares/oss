<div class="main-navbar relative flex flex-row order-2 w-full px-10">
	<div class="site-logo pb-4">
		<a href="${site_default_url}" class="inline-block text-app-blue--egyptian" title="<@liferay.language_format arguments="${site_name}" key="go-to-x" />">
			<svg xmlns="http://www.w3.org/2000/svg" width="773" height="149" viewBox="0 0 773 149" aria-hidden="true" aria-label="Logo van Deltares" class="w-44 h-auto">
			...
			<span class="sr-only">Naar homepage</span>
		</a>
	</div>
