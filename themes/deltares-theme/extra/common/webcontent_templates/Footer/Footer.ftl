    ...
    <div class="container mx-auto">
        <div class="row px-3">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <#if FooterLinksLeftFieldSet.LinkToPage.getSiblings()?has_content>
                    <h2 class="mb-3 text-base font-semibold text-white"><@liferay.language key='dsd.theme.footer.info.header' /></h2>
                    <ul class="link-list">
                        <#list FooterLinksLeftFieldSet.LinkToPage.getSiblings() as cur_FooterLinkLeft>
                            <#assign linkData = cur_FooterLinkLeft.getData()?eval >
                            <li>
                                <#assign linkLayout=layoutUtils.getLinkToPageLayout(linkData.groupId?number, false, linkData.layoutId?number) />
                                <a href="${cur_FooterLinkLeft.getFriendlyUrl()}" class="underline-offset-2 font-semibold inline-flex items-center transition duration-200 items-start leading-none cursor-pointer text-white text-base tracking-wider">
                ...
                <#if FooterLinksLeftFieldSet.LinkToPage?? && FooterLinksLeftFieldSet.LinkToPage.getSiblings()?has_content && validator.isNotNull(FooterLinksLeftFieldSet.LinkToPage.getSiblings()?first.getData())>
                    <h2 class="mb-3 text-base font-semibold text-white"><@liferay.language key='dsd.theme.footer.info.header' /></h2>
                    <ul class="link-list">
                        <#list FooterLinksLeftFieldSet.LinkToPage.getSiblings() as cur_FooterLinkLeft>
                            <#assign linkData = cur_FooterLinkLeft.getData()?eval >
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <ul class="media-links flex gap-2">
                    ...
                    <#if FooterSocialMediaLinksFieldSet.Facebook?? && FooterSocialMediaLinksFieldSet.Facebook.getData()??>
                        <li>
                            <a class="uppercase font-medium text-base inline-flex transition duration-200 items-start rounded-full leading-none tracking-wider cursor-pointer border-current py-2 px-2 border-2 border-solid text-white" href="${FooterSocialMediaLinksFieldSet.Facebook.getData()}" aria-label="go to our facebook page" title="go to our facebook page">
                    ...
                    <#if FooterSocialMediaLinksFieldSet.Twitter?? && FooterSocialMediaLinksFieldSet.Twitter.getData()??>
                        <li>
                            <a class="uppercase font-medium text-base inline-flex transition duration-200 items-start rounded-full leading-none tracking-wider cursor-pointer border-current py-2 px-2 border-2 border-solid text-white" href="${FooterSocialMediaLinksFieldSet.Twitter.getData()}" aria-label="go to our twitter page" title="go to our twitter page">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" aria-hidden="false" role="img" class="w-5 h-5">
                    ...
                    <#if FooterSocialMediaLinksFieldSet.Youtube?? && FooterSocialMediaLinksFieldSet.Youtube.getData()??>
                        <li>
                            <a class="uppercase font-medium text-base inline-flex transition duration-200 items-start rounded-full leading-none tracking-wider cursor-pointer border-current py-2 px-2 border-2 border-solid text-white" href="${FooterSocialMediaLinksFieldSet.Youtube.getData()}" aria-label="go to our youtube page" title="go to our youtube page">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" aria-hidden="false" role="img" class="w-5 h-5">
                    ...
                    <#if FooterSocialMediaLinksFieldSet.Linkedin?? && FooterSocialMediaLinksFieldSet.Linkedin.getData()??>
                        <li>
                            <a class="uppercase font-medium text-base inline-flex transition duration-200 items-start rounded-full leading-none tracking-wider cursor-pointer border-current py-2 px-2 border-2 border-solid text-white" href="${FooterSocialMediaLinksFieldSet.Linkedin.getData()}" aria-label="go to our linkedin page" title="go to our linkedin page">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" aria-hidden="false" role="img" class="w-5 h-5">
...
<div class="footer-bottom px-4 text-sm">
    <div class="container mx-auto">
        ...
        <#if FooterLinksRightFieldSet.LinkToPage1?? && FooterLinksRightFieldSet.LinkToPage1.getSiblings()?has_content && validator.isNotNull(FooterLinksRightFieldSet.LinkToPage1.getSiblings()?first.getData())>
            <ul>
                <#list FooterLinksRightFieldSet.LinkToPage1.getSiblings() as cur_FooterLinksRight>
