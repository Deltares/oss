...
<#assign urlUtils = serviceLocator.findService("nl.deltares.portal.utils.URLUtils") />
...
<#assign redirectUrl= themeDisplay.getSiteGroup().getDisplayURL(themeDisplay) + "/my-program" />
                ...
                <span class="d-block" style="float:right">
                    <#if dsdSessionUtils.isUserRegistered(themeDisplay.getUser(), registration)>
                        ...
                        <#if joinLink?? && joinLink != "">
                            ...
                            <a href="${urlUtils.getUnregisterURL(renderRequest, registration.getArticleId(), userId, redirectUrl) }" class="btn-lg btn-primary" role="button" aria-pressed="true" style="color:#fff">
