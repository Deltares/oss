            ...
            <#if showButtons >
                ...
                <span class="d-block" style="float:right">
                    <table >
                        ...
                        <tr><td>
                            <a href="${urlUtils.getUnregisterURL(renderRequest, registration.getArticleId(), registeredUser.getUserId(), redirectUrl) }" class="btn-lg btn-primary" role="button" aria-pressed="true" style="color:#fff">
