create index IX_7DD2C1EF on Registrations_Registration (groupId, eventResourcePrimaryKey, registeredByUserId);
create index IX_EF4176CF on Registrations_Registration (groupId, parentResourcePrimaryKey);
create index IX_EA80857C on Registrations_Registration (groupId, registeredByUserId, eventResourcePrimaryKey);
