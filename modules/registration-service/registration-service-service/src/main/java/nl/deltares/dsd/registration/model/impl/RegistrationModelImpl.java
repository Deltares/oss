...
public class RegistrationModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"userId", Types.BIGINT}, {"articleId", Types.BIGINT},
	...
	public static final String TABLE_SQL_CREATE =
		"create table Registrations_Registration (uuid_ VARCHAR(75) null,registrationId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,articleId LONG,userPreferences VARCHAR(500) null,startTime DATE null,endTime DATE null)";
	...
	public static final String ORDER_BY_SQL =
		" ORDER BY Registrations_Registration.registrationId ASC";
	...
	static {
		...
		attributeGetterFunctions.put("articleId", Registration::getArticleId);
		attributeSetterBiConsumers.put(
			"articleId",
			(BiConsumer<Registration, Long>)Registration::setArticleId);
		attributeGetterFunctions.put(
	...
	public int compareTo(Registration registration) {
		...
		if (getRegistrationId() < registration.getRegistrationId()) {
			value = -1;
		}
		else if (getRegistrationId() > registration.getRegistrationId()) {
			value = 1;
		}
		else {
			value = 0;
