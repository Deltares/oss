...
public class RegistrationLocalServiceImpl
    ...
    public List<Registration> getRegistrationsWithOverlappingPeriod(long groupId, long userId, Date startTime, Date endTime) {
        Criterion checkUserId = PropertyFactoryUtil.forName("userId").eq(userId);
        Criterion checkGroupId = PropertyFactoryUtil.forName("groupId").eq(groupId);
...
//		Criterion checkStart = PropertyFactoryUtil.forName("startTime").eq(startDate);
    ...
    public List<Registration> getRegistrationDataByAuthorAndResourceId(long authorId, long resourceId) {
        ...
        Criterion checkRegistrationId = PropertyFactoryUtil.forName("resourcePrimaryKey").eq(resourceId);
        DynamicQuery query = DynamicQueryFactoryUtil.forClass(Registration.class,
                getClass().getClassLoader()).add(checkRegisteredByUserId).add(checkRegistrationId);
        return RegistrationUtil.findWithDynamicQuery(query);
    }

    public List<Registration> getRegistrationDataByUserAndResourceId(long userId, long resourceId) {
