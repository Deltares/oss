package com.worth.deltares.deploy.hot;
...
@Component(
		immediate = true,
		property = {
			"context.id=CustomTermsOfUseJspBag", "context.name=Custom Terms of Use jsp",
			"service.ranking:Integer=100"
		}
	)
public class CustomTermsOfUseJspBag implements CustomJspBag {
