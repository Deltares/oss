...
public class EmailUtils {
    ...
    public static String sendTestEmail(User user, String sendToEmail, String source) throws Exception {
        ...
        sendEmail(body, subject, sendToEmail, null, (String)null, user.getEmailAddress(), null,
    ...
    static void sendEmail(String body, String subject, String sendToEmail, List<String> sendCcEmail, List<String> sendBccEmail,
        ...
        Session session = getSession(data, props);
        try {
    ...
    private static void setMailCommandProperties() {
        MailcapCommandMap mc = (MailcapCommandMap) CommandMap.getDefaultCommandMap();
        mc.addMailcap("text/html;; x-java-content-handler=com.sun.mail.handlers.text_html");
        mc.addMailcap("multipart/*;; x-java-content-handler=com.sun.mail.handlers.multipart_mixed");
    }

    private static Session getSession(Map<String, Object> data, Properties props) {
    ...
    private static Address[] toInternetAddresses(List<String> emailList) {
