...
public class BillingConstants {
    ...
    public static final String ORG_REGION ="billing_org_region";
    ...
    public static final String BILLING_ADDRESS_ID="select_address";

    public static final String[] ORG_KEYS = {ORG_NAME, ORG_STREET, ORG_POSTAL, ORG_CITY, ORG_COUNTRY_CODE, ORG_REGION,
