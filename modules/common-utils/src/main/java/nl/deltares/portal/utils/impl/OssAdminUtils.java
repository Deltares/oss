...
public class OssAdminUtils implements AdminUtils {
    ...
    public void deleteUserAndRelatedContent(long siteId, long userId, PrintWriter writer) {
        ...
        writer.printf("Deleted asset entries for groupId '%s'\n", siteId);
        ...
        try {
            ...
            writer.printf("Deleted asset entries for group 'Control Panel'\n");
        } catch (PortalException e) {
        ...
        try {
            ...
            for (AssetEntry entry : entries) {
                ...
                if (entry.getClassName().equals(DLFileEntry.class.getName())) {
                    ...
                    try {
                        DLFileEntry fileEntry = DLFileEntryLocalServiceUtil.deleteFileEntry(entry.getClassPK());
