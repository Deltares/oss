...
public class DownloadLocalServiceUtil {
	...
	private static final Snapshot<DownloadLocalService> _serviceSnapshot =
		new Snapshot<>(
			DownloadLocalServiceUtil.class, DownloadLocalService.class);

}
// LIFERAY-SERVICE-BUILDER-HASH:674704409