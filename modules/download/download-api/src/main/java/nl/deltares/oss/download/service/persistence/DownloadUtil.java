...
public class DownloadUtil {
	...
	public static List<Download> findByDownloads(
		...
		return getPersistence().findByDownloads(
			groupId, downloadId, start, end, orderByComparator, useFinderCache);
	}
	...
	public static Download fetchByUserDownload(
		...
		return getPersistence().fetchByUserDownload(
			groupId, userId, downloadId, useFinderCache);
	}
	...
	public static void setPersistence(DownloadPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile DownloadPersistence _persistence;

}
// LIFERAY-SERVICE-BUILDER-HASH:869547615