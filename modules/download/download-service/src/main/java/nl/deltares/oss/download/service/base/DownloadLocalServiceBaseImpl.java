...
public abstract class DownloadLocalServiceBaseImpl
	...
	implements DownloadLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DownloadLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>nl.deltares.oss.download.service.DownloadLocalServiceUtil</code>.
	 */
	 ...
	 */
	public DownloadLocalService getDownloadLocalService() {
	 ...
	 */
	public nl.deltares.oss.download.service.DownloadCountLocalService
		getDownloadCountLocalService() {
	...
	public void setDownloadCountLocalService(
		nl.deltares.oss.download.service.DownloadCountLocalService
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"nl.deltares.oss.download.model.Download", downloadLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"nl.deltares.oss.download.model.Download");
	}
	...
	@BeanReference(type = DownloadLocalService.class)
	...
	@BeanReference(
		type = nl.deltares.oss.download.service.DownloadCountLocalService.class
	)
	protected nl.deltares.oss.download.service.DownloadCountLocalService
		downloadCountLocalService;
