...
public class DownloadPersistenceImpl
	...
	public List<Download> findByDownloadsByShareId(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_DOWNLOADSBYSHAREID_GROUPID_2);

			sb.append(_FINDER_COLUMN_DOWNLOADSBYSHAREID_SHAREID_2);
	...
	public List<Download> findByUserDownloadsByShareId(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_USERDOWNLOADSBYSHAREID_GROUPID_2);

			sb.append(_FINDER_COLUMN_USERDOWNLOADSBYSHAREID_USERID_2);

			sb.append(_FINDER_COLUMN_USERDOWNLOADSBYSHAREID_SHAREID_2);
	...
	public List<Download> findByDirectDownloads(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_DIRECTDOWNLOADS_GROUPID_2);
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByDownloadsByShareId = new FinderPath(
			...
			new String[] {"groupId", "shareId"}, true);
		...
		_finderPathCountByDownloadsByShareId = new FinderPath(
			...
			new String[] {Long.class.getName(), Integer.class.getName()},
			new String[] {"groupId", "shareId"}, false);
		...
		_finderPathWithPaginationFindByUserDownloadsByShareId = new FinderPath(
			...
			new String[] {"groupId", "userId", "shareId"}, true);
		...
		_finderPathCountByUserDownloadsByShareId = new FinderPath(
			...
			new String[] {"groupId", "userId", "shareId"}, false);
