...
<aui:form action="<%= addRegistrationURL %>" name="<portlet:namespace />fm">
    ...
    <aui:fieldset>
        ...
        <aui:select name="<%=KeycloakUtils.ATTRIBUTES.org_preferred_payment.name()%>" type="select" label="registrationform.paymethod"  value="<%=  attributes.get(KeycloakUtils.ATTRIBUTES.org_preferred_payment.name()) %>" >
