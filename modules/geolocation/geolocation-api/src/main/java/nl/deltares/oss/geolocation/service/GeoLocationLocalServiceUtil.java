...
public class GeoLocationLocalServiceUtil {
	...
	private static final Snapshot<GeoLocationLocalService> _serviceSnapshot =
		new Snapshot<>(
			GeoLocationLocalServiceUtil.class, GeoLocationLocalService.class);

}
// LIFERAY-SERVICE-BUILDER-HASH:-1700332584