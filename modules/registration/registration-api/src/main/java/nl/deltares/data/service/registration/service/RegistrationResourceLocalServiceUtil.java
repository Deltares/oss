...
/**
 * Provides the local service utility for RegistrationResource. This utility wraps
 * <code>nl.deltares.data.service.registration.service.impl.RegistrationResourceLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RegistrationResourceLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>nl.deltares.data.service.registration.service.impl.RegistrationResourceLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RegistrationResource addRegistrationResource(
		RegistrationResource registrationResource) {

		return getService().addRegistrationResource(registrationResource);
	}
	 ...
	 */
	public static RegistrationResource createRegistrationResource(
		long registrationResourceId) {

		return getService().createRegistrationResource(registrationResourceId);
	}
	 ...
	 */
	public static RegistrationResource deleteRegistrationResource(
			long registrationResourceId)
		throws PortalException {

		return getService().deleteRegistrationResource(registrationResourceId);
	}
	...
	public static RegistrationResource deleteRegistrationResource(
		...
		return getService().deleteRegistrationResource(registrationResource);
	}
	...
	public static RegistrationResource fetchRegistrationResource(
		long registrationResourceId) {
	 ...
	 * @throws PortalException if a registration resource with the primary key could not be found
	 */
	public static RegistrationResource getRegistrationResource(
			long registrationResourceId)
		throws PortalException {

		return getService().getRegistrationResource(registrationResourceId);
	}
	 ...
	 */
	public static List<RegistrationResource> getRegistrationResources(
		int start, int end) {

		return getService().getRegistrationResources(start, end);
	}
	 ...
	 */
	public static int getRegistrationResourcesCount() {
		return getService().getRegistrationResourcesCount();
	}
	 ...
	 */
	public static RegistrationResource updateRegistrationResource(
		RegistrationResource registrationResource) {

		return getService().updateRegistrationResource(registrationResource);
	}

	public static RegistrationResourceLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<RegistrationResourceLocalService>
		_serviceSnapshot = new Snapshot<>(
			RegistrationResourceLocalServiceUtil.class,
