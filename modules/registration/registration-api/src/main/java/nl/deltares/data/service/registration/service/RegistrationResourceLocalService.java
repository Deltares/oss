...
/**
 * Provides the local service interface for RegistrationResource. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RegistrationResourceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RegistrationResourceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>nl.deltares.data.service.registration.service.impl.RegistrationResourceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the registration resource local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RegistrationResourceLocalServiceUtil} if injection and service tracking are not available.
	 */
