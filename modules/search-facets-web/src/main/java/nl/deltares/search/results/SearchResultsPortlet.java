...
public class SearchResultsPortlet extends MVCPortlet {
    ...
    private void passSearchParametersToResponse(PortletSharedSearchResponse portletSharedSearchResponse, RenderRequest renderRequest, RenderResponse renderResponse) {
        ...
        final Optional<String> typeOptional = Optional.ofNullable(portletSharedSearchResponse.getParameter("session-registrationType", renderRequest));
        ...
        final Optional<String> topicOptional = Optional.ofNullable(portletSharedSearchResponse.getParameter("session-topic", renderRequest));
        ...
        final Optional<String> startDateOptional = Optional.ofNullable(portletSharedSearchResponse.getParameter("startDate", renderRequest));
        ...
        final Optional<String> endDateOptional = Optional.ofNullable(portletSharedSearchResponse.getParameter("endDate", renderRequest));
        ...
        final Optional<String> languageOptional = Optional.ofNullable(portletSharedSearchResponse.getParameter("session-Language", renderRequest));
