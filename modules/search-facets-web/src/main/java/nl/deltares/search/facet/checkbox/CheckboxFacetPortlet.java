...
@Component(
        ...
        property = {
                ...
                "jakarta.portlet.display-name=CheckboxFacet",
                "jakarta.portlet.expiration-cache=0",
                "jakarta.portlet.init-param.template-path=/",
                "jakarta.portlet.init-param.config-template=/facet/checkbox/configuration.jsp",
                "jakarta.portlet.init-param.view-template=/facet/checkbox/view.jsp",
