...
public class SessionTopicFacet extends BaseFacet implements Facet {

    public SessionTopicFacet(String fieldName, SearchContext searchContext, FilterBuilders filterBuilders) {
        super(searchContext);
