...
@Component(
        ...
        property = {
                ...
                "jakarta.portlet.display-name=TermsFacet",
                "jakarta.portlet.expiration-cache=0",
                "jakarta.portlet.init-param.template-path=/",
                "jakarta.portlet.init-param.config-template=/facet/terms/configuration.jsp",
                "jakarta.portlet.init-param.view-template=/facet/terms/view.jsp",
