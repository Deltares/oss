...
/**
 * Provides the local service interface for RepositoryFolderPermission. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Pier-Angelo Gaetani @ Worth Systems
 * @see RepositoryFolderPermissionLocalServiceUtil
...
public interface RepositoryFolderPermissionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RepositoryFolderPermissionLocalServiceUtil} to access the repository folder permission local service. Add custom service methods to {@link com.worth.deltares.subversion.service.impl.RepositoryFolderPermissionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public RepositoryFolderPermission addRepositoryFolderPermission(
		RepositoryFolder folder, Role role, java.lang.String permission,
		boolean recurse);

	public RepositoryFolderPermission addRepositoryFolderPermission(
		RepositoryFolder folder, User user, java.lang.String permission,
		boolean recurse);
	...
	*/
	...
	public List<RepositoryFolderPermission> addRepositoryFolderPermissions(
		...
		boolean recurse) throws java.lang.Exception, SystemException;
	...
	*/
	...
	public RepositoryFolderPermission createRepositoryFolderPermission(
		long repositoryId, java.lang.String folderName, Role role,
		java.lang.String permission);

	public RepositoryFolderPermission createRepositoryFolderPermission(
		long repositoryId, java.lang.String folderName, User user,
		java.lang.String permission);
	...
	*/
	...
	public RepositoryFolderPermission deleteRepositoryFolderPermission(
		long permissionId) throws PortalException;
