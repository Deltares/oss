...
/**
 * This class is used by SOAP remote services, specifically {@link com.worth.deltares.subversion.service.http.RepositoryLogServiceSoap}.
 *
 * @author Pier-Angelo Gaetani @ Worth Systems
 * @see com.worth.deltares.subversion.service.http.RepositoryLogServiceSoap
 * @generated
 */
@ProviderType
public class RepositoryLogSoap implements Serializable {
	...
	public static RepositoryLogSoap[] toSoapModels(List<RepositoryLog> models) {
		List<RepositoryLogSoap> soapModels = new ArrayList<RepositoryLogSoap>(models.size());
