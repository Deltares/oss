...
/**
 * This class is used by SOAP remote services, specifically {@link com.worth.deltares.subversion.service.http.RepositoryFolderServiceSoap}.
 *
 * @author Pier-Angelo Gaetani @ Worth Systems
 * @see com.worth.deltares.subversion.service.http.RepositoryFolderServiceSoap
 * @generated
 */
@ProviderType
public class RepositoryFolderSoap implements Serializable {
	public static RepositoryFolderSoap toSoapModel(RepositoryFolder model) {
		...
		soapModel.setWorldRead(model.getWorldRead());
		soapModel.setWorldWrite(model.getWorldWrite());
	...
	public static RepositoryFolderSoap[] toSoapModels(RepositoryFolder[] models) {
		RepositoryFolderSoap[] soapModels = new RepositoryFolderSoap[models.length];
	...
	public static RepositoryFolderSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new RepositoryFolderSoap[models.length][models[0].length];
		}
		else {
	...
	public static RepositoryFolderSoap[] toSoapModels(
		...
		List<RepositoryFolderSoap> soapModels = new ArrayList<RepositoryFolderSoap>(models.size());
