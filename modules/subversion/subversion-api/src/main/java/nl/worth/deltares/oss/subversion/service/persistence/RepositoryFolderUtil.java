...
/**
 * The persistence utility for the repository folder service. This utility wraps <code>nl.worth.deltares.oss.subversion.service.persistence.impl.RepositoryFolderPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class RepositoryFolderUtil {
	 ...
	 */
	public static Map<Serializable, RepositoryFolder> fetchByPrimaryKeys(
	 ...
	 */
	public static RepositoryFolder update(
		RepositoryFolder repositoryFolder, ServiceContext serviceContext) {
	 ...
	 */
	public static List<RepositoryFolder> findByRepositoryId(
	...
	public static List<RepositoryFolder> findByRepositoryId(
		...
		return getPersistence().findByRepositoryId(
			repositoryId, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 */
	public static RepositoryFolder findByRepositoryId_First(
			long repositoryId,
			OrderByComparator<RepositoryFolder> orderByComparator)
	 ...
	 * @throws NoSuchRepositoryFolderException if a matching repository folder could not be found
	 */
	public static RepositoryFolder findByRepositoryId_Last(
			long repositoryId,
			OrderByComparator<RepositoryFolder> orderByComparator)
		throws nl.worth.deltares.oss.subversion.exception.
			NoSuchRepositoryFolderException {
	 ...
	 */
	public static RepositoryFolder fetchByRepositoryId_Last(
		long repositoryId,
		OrderByComparator<RepositoryFolder> orderByComparator) {
	...
	public static RepositoryFolder updateImpl(
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			RepositoryFolderPersistence.class);

		ServiceTracker<RepositoryFolderPersistence, RepositoryFolderPersistence>
			serviceTracker =
				new ServiceTracker
					<RepositoryFolderPersistence, RepositoryFolderPersistence>(
						bundle.getBundleContext(),
						RepositoryFolderPersistence.class, null);
