...
public interface RepositoryLogLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>nl.worth.deltares.oss.subversion.service.impl.RepositoryLogLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the repository log local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RepositoryLogLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RepositoryLog deleteRepositoryLog(long logId) throws PortalException;
