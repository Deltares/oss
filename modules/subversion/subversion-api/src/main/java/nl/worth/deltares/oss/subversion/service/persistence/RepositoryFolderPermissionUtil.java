...
public class RepositoryFolderPermissionUtil {
	...
	private static ServiceTracker
		<RepositoryFolderPermissionPersistence,
		 RepositoryFolderPermissionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			RepositoryFolderPermissionPersistence.class);

		ServiceTracker
			<RepositoryFolderPermissionPersistence,
			 RepositoryFolderPermissionPersistence> serviceTracker =
				new ServiceTracker
					<RepositoryFolderPermissionPersistence,
					 RepositoryFolderPermissionPersistence>(
						 bundle.getBundleContext(),
						 RepositoryFolderPermissionPersistence.class, null);
