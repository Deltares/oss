...
/**
 * This class is used by SOAP remote services, specifically {@link nl.worth.deltares.oss.subversion.service.http.RepositoryFolderPermissionServiceSoap}.
 *
...
public class RepositoryFolderPermissionSoap implements Serializable {
	...
	public static RepositoryFolderPermissionSoap[] toSoapModels(
		...
		RepositoryFolderPermissionSoap[] soapModels =
			new RepositoryFolderPermissionSoap[models.length];
	...
	public static RepositoryFolderPermissionSoap[] toSoapModels(
		...
		List<RepositoryFolderPermissionSoap> soapModels =
			new ArrayList<RepositoryFolderPermissionSoap>(models.size());
		...
		return soapModels.toArray(
			new RepositoryFolderPermissionSoap[soapModels.size()]);
	}
