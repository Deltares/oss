...
public abstract class RepositoryFolderPermissionServiceBaseImpl
	...
	implements RepositoryFolderPermissionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RepositoryFolderPermissionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>nl.worth.deltares.oss.subversion.service.RepositoryFolderPermissionServiceUtil</code>.
	 */
	 ...
	 */
	public nl.worth.deltares.oss.subversion.service.RepositoryFolderService
		getRepositoryFolderService() {
	...
	public void setRepositoryFolderService(
		nl.worth.deltares.oss.subversion.service.RepositoryFolderService
	 ...
	 */
	public RepositoryFolderPermissionService
	...
	@BeanReference(
		type = nl.worth.deltares.oss.subversion.service.RepositoryFolderService.class
	)
	protected nl.worth.deltares.oss.subversion.service.RepositoryFolderService
		repositoryFolderService;
