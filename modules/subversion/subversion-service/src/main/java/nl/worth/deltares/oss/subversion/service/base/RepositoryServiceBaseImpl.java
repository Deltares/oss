...
import nl.worth.deltares.oss.subversion.service.RepositoryServiceUtil;
...
public abstract class RepositoryServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, RepositoryService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RepositoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		repositoryService = (RepositoryService)aopProxy;
