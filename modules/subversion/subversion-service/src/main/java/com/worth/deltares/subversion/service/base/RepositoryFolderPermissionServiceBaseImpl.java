...
import com.worth.deltares.subversion.service.RepositoryFolderPermissionService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.worth.deltares.subversion.service.impl.RepositoryFolderPermissionServiceImpl}.
 * </p>
 *
...
public abstract class RepositoryFolderPermissionServiceBaseImpl
	extends BaseServiceImpl implements RepositoryFolderPermissionService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.worth.deltares.subversion.service.RepositoryFolderPermissionServiceUtil} to access the repository folder permission remote service.
	 */
	 ...
	 */
	public com.worth.deltares.subversion.service.RepositoryService getRepositoryService() {
	...
	public void setRepositoryService(
		com.worth.deltares.subversion.service.RepositoryService repositoryService) {
	 ...
	 */
	public RepositoryFolderPermissionService getRepositoryFolderPermissionService() {
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = repositoryFolderPermissionPersistence.getDataSource();
	...
	@BeanReference(type = com.worth.deltares.subversion.service.RepositoryService.class)
	protected com.worth.deltares.subversion.service.RepositoryService repositoryService;
	...
	@BeanReference(type = RepositoryFolderPermissionService.class)
	protected RepositoryFolderPermissionService repositoryFolderPermissionService;
